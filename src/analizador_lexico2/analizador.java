                ...
                switch(estado){ 
                    ...
                    case 8: 
                        ...
                        if(n_siguiente == 45){
                            ...
                            estado = 9;
                            //Si el siguiente es una barra diagonal
                        }else if(n_siguiente == 47){
                            //Cambia al estado de cierre de bloque de comentario    
                            estado = 12;
                            //Si el siguiente es otro guión
                        }else if(n_siguiente == 43){
                            //Cambia al estado de decremento   
                            estado = 209;
                        }
                        else{
                            numero_token = 8;
                    ...
                    case 10:
                        ...
                        if(n_siguiente == 45){
                            //Cambia a estado de aceptación de inicio de de bloque de comentario
                            estado =11;
                        } else{
                          numero_token = 10;
                          tipo = "División";
                        ...
                        break;
                    //Estado de aceptación de inicio de de bloque de comentario
                    case 11:
                        lexema = lexema + lineas[i].charAt(j);
                        numero_token =11;
                        tipo = "Inicio de Bloque de comentario";
                        estado = 0;
                        break;
